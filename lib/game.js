...
const buyCompanyEvent = (companyData) => {
    ...
    .then(data => handleCompanyPurchase(data, companyData))
...
const handleCompanyPurchase = (data, companyData) => {
...
const sufficientFunds = (companyPrice, userFunds) => {
    if (userFunds > companyPrice) {
        return true;
    } else {
        return false;
    }
