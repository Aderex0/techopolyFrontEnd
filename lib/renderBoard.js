...
const createMoney = (player) => {
    ...
    money.setAttribute("id", player.id)
    return money
}
...
const findTile = (company) => {
    ...
    tile.className = `player${company.player_id}`
    return tile
}
...
const createFundingRounds = () => {
    let fundingRound1 = document.querySelector(`div[data-id="11"]`)
    let name1 = document.createElement("h2")
    name1.textContent = "Funding Round!"
    fundingRound1.appendChild(name1)

    let fundingRound2 = document.querySelector(`div[data-id="29"]`)
    let name2 = document.createElement("h2")
    name2.textContent = "Funding Round!"
    fundingRound2.appendChild(name2)
}
